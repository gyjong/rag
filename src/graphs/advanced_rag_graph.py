...
def generate_stream_node(state: AdvancedRagState, llm_manager: LLMManager):
    """Generates the final answer."""
    logger.info("-"*80)
    logger.info("--- STEP 5/5: Answer Generation ---")
...
def create_advanced_rag_stream_graph(llm_manager: LLMManager, vector_store_manager: VectorStoreManager):
    """Creates the Advanced RAG graph."""
    workflow = StateGraph(AdvancedRagState)
